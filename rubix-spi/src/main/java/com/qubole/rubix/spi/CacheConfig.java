...
public class CacheConfig
{
  ...
  private static final String KEY_ENABLE_METRICS = "rubix.metrics.enabled";
  private static final String KEY_METRICS_CLASS_IMPL = "rubix.metrics.class.impl";
  ...
  private static final String DEFAULT_METRICS_CLASS_IMPL = "com.qubole.rubix.common.CodahaleMetrics";
  ...
  {
    return conf.get(KEY_METRICS_CLASS_IMPL, DEFAULT_METRICS_CLASS_IMPL);
  }
  ...
  {
    return conf.getBoolean(KEY_ENABLE_METRICS, DEFAULT_ENABLE_METRICS);
  }
}

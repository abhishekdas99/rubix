...
public class CacheConfig
{
    ...
    private static String isFastCacheReadEnabled = "hadoop.cache.fast.cache.read";
    ...
    private static boolean isFastCacheReadEnabledDefault = false;
    ...
    public static boolean isFastCacheReadEnabled(Configuration conf)
    {
        return conf.getBoolean(isFastCacheReadEnabled, isFastCacheReadEnabledDefault);
    }
}
